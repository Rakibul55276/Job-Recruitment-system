...
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
 ...
 <li>
 <a href="index_seek.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <font style="color:white"> Home </font></a>
 </li>
 <!--
 <li>
...
<div class="row" style="clear:both">
 <div class="col-lg-12">
   ...
   <a href="index_seek.php" class="list-group-item active" style="background-color:black;">
    Home</a>
 ...
 <a href="ourskill.php" class="list-group-item">Profile
  ...
  <a href="php_resumepost.php" class="list-group-item">My Resume
  </a>
  ...
  <a href="changepass.php" class="list-group-item">Change Password
     ...
     <a target="_blank" href="../chat/index.php" class="list-group-item" name="submit">Instant Job</a>
