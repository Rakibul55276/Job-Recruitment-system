...
?>
            ...
            <div class="post-footer">
                <div class="input-group"> 
                    ...
                    <textarea class="form-control" cols="100" rows="10" placeholder="Add a comment" type="text" name="comment" required></textarea>
                ...
                <a href="send_attach.php" class="btn btn-info" role="button" target="_blank">Apply</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <a href="index_seek.php" class="mt-5 mb-3 text-muted" id="btmn">Back</a>
				</div>
                </div>
                </form>
