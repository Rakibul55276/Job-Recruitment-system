 ...
 <!--<header> 
      ...
      <nav>
        <ul>
          ...
          <li><button class= "button-header" onclick = "document.location.href='php_resumepost.php'"> Home </button> </li>       
        </ul>
      </nav>
...
border-radius: 50%;  
        ...
        <div class="download_btn">
              <a target="_blank" href="resume_pdf.php?id=<?= $row['id']?>" class="download_link" name="submit" style=" ">Download Resume</a>
            </div>
