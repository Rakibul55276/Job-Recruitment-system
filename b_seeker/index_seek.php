...
<?php include('header1.php') ?>
 ...
 <?php 
						...
						echo '<div class="post-show" style="width:90%;border-radius:5px">
							...
							echo '<a href="project_description.php?id='.$id.'&s_title=' . $row['status'] . '" class="btn btn-default">Post Your Comment</a>'?>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<a  target="_blank" href="send_attach.php"class="btn btn-default" name="submit" style ="text-decoration: none;position: center"></style>Apply</a>
...
echo "<a href='index_seek.php?page=1'>".'|< Prev '."</a> "; 
// Goto 1st page  

for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='index_seek.php?page=".$i."'>" .$i. "</a> "; 
}; 
echo "<a href='index_seek.php?page=$total_pages'>".' Next >|'."</a> "; // Goto last page
echo '</div>'; 
