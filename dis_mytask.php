...
<?php include('header1.php') ?>
            <!--left-content-->
                    ...
                    $sql=mysqli_query($con,"select * from defaults where usr_id_p='$uid' order by defaults.status_time desc");
							//$sql ="SELECT * from `defaults` where usr_id_p='$uid'order by defaults.status_time";
							//$result = 
