...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <body>
	...
	<div id="mySidenav" class="sidenav">
		<a class="page-scroll" href="#first" id="menu" alt="Menu" title="Menu"></a>
		<a class="page-scroll" href="#one" id="energy" alt="Energy" title="Energy"></a>
		<a class="page-scroll" href="#two" id="solar" alt="solar" title="solar"></a>
		<a class="page-scroll" href="#three" id="powerwall" alt="powerwall" title="powerwall"></a>
	    <a class="page-scroll" href="#last" id="quote" alt="quote" title="quote"></a>
	</div>
</nav>
	
	<section class="container-fluid" id="first">
	<div class="row">
...
<div id="wowslider-container1">
  <div class="ws_images">
    <ul>
      ...
      <li><img src="data1/images/resume5.jpg" alt="Resume 5" title="Resume 5" id="wows1_3"/></li>
    </ul>
    <script>
                    var all = document.getElementsById('wowslider-container1');
for (var i = 0; i < all.length; i++) {
  all[i].style.color = 'black';
  ...
  <div class="ws_bullets">
    <div>
      ...
      <a href="#" title="Resume 4"><span><img src="data1/tooltips/resume4.jpg" alt="Resume 4"/>4</span></a>
       <a href="#" title="Resume 5"><span><img src="data1/tooltips/resume5.jpg" alt="Resume 5"/>4</span></a>
    </div>
  </div>
...
<p>
<h3>here we are conduct you to achieve your dreams...</h3>
</p>
<h4 id="clockDisplay"></h4>
<style>
    h3
    {
        color:black;
