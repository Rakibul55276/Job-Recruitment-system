...
<div class='move'>
  ...
  <table>
      ...
      <tr>
      <td>
      <p class='jobtext2'><?php echo ucwords($row['p_name']); ?></p>
      <p class='jobtext1'><?php echo ucwords($row['details']); ?>,</p>
      </td>
	  ...
	  <td>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php echo '<a href="delete_product.php?pid='.$id.'" class="btn btn-default">Delete</a>';?>
	  </td>
